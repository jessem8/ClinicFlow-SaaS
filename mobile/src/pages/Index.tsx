...
export default function Index() {
  ...
  return (
    <PublicLayout>
      <div className="min-h-[100dvh] pb-[env(safe-area-inset-bottom)] bg-gray-950">
        {/* Hero Section - Dark with Gradient */}
        <section className="relative min-h-[90vh] flex items-center bg-gray-950 overflow-hidden pt-[env(safe-area-inset-top)]">
